...
public partial class EJEMPLOCDASQLContext : DbContext
{
    public EJEMPLOCDASQLContext(DbContextOptions<EJEMPLOCDASQLContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdActor).HasName("PK__Actores__F86BE71724D08A36");
        ...
        {
            entity.HasKey(e => e.IdActuacion).HasName("PK__Actuacio__9D26834341868FA9");
        ...
        {
            entity.HasKey(e => e.IdDirector).HasName("PK__Director__6B65E2A2C7832B3E");
        ...
        {
            entity.HasKey(e => e.IdGenero).HasName("PK__Generos__99A8E4F9FA0925D6");
        ...
        {
            entity.HasKey(e => e.IdPelicula).HasName("PK__Pelicula__B5017F4DF667C10F");
        ...
        {
            entity.HasKey(e => e.IdPeliculaGenero).HasName("PK__Pelicula__021DFEC065BF7A29");
        ...
        {
            entity.HasKey(e => e.IdProductora).HasName("PK__Producto__0E435047725C9227");
        ...
        {
            entity.HasKey(e => e.IdRanking).HasName("PK__Rankings__2001139949C059B4");
